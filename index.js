window.onload = function () {
    ...
    buttonStop.onclick = function() {
        clearInterval(interval);
        var id = 0;
        if (`${minSpan.innerHTML}:${secSpan.innerHTML}:${tenSpan.innerHTML}` !== "00:00:00") {
            ...
            var spanText = document.createTextNode(minSpan.innerHTML+':'+secSpan.innerHTML+':'+tenSpan.innerHTML);
